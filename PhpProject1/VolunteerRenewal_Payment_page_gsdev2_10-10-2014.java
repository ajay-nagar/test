<apex:page controller="VolunteerRenewal_PaymentController" standardStylesheets="false"  sidebar="false" cache="false">
    ...
    <!--
    <script type="text/javascript" src="//netdna.bootstrapcdn.com/bootstrap/3.0.2/js/bootstrap.js"></script>
    ...
    <apex:outputPanel styleClass="isSiteDownPanel" html-isSiteDown="{!$Setup.Site_Maintenance_Setting__c.Volunteer_Renewal_Maintenance__c}" />
    <script>
    ...
    <div class="container">
        ...
        <apex:outputPanel id="payemntPanel">
            <div class="row">
                <lable style="text-align: left; font-size:22px;font-weight:bold;">Pay for your membership</lable>
                <apex:outputLabel value="At Girl Scouts, we believe every girl should have a chance to shine. But some girls need help to cover costs like membership and uniforms in order to participate. A small contribution can help us provide scholarships that directly benefit girls in our area—so more girls can join the fun and unlock their potential with Girl Scouts." id="fiL1abel" styleClass="col-sm-12 control-label myFirstName"  style="text-align: left;"/><br/>
            </div>
            <br/>
            <div class="row">
                <apex:outputLabel value="Here's what your tax-deductible donation can do:"  id="fiLabel11" styleClass="col-sm-10 " style="text-align: left;"/>
            </div>
            <div class="row">
                <apex:outputLabel value="$15 helps with her membership fee." id="fiLabel12" styleClass="col-sm-10 "  style="text-align: left; margin-left: 60px;"/>
            </div>
            <div class="row">
            ...
            <div class="row">
                <apex:outputLabel value="$150 helps with membership fees for a troop of 10." id="fiLabel14" styleClass="col-sm-10 "  style="text-align: left; margin-left: 60px;"/>
            </div>
            <div class="form-group" style = "margin-left: 1px;">
                <br/>
                <apex:outputPanel layout="none" rendered="{!AND(NOT(confirmTransactions))}"><!-- {!AND(NOT(confirmTransactions,opportunityTransactionList == null))} -->
                    ...
                    <table class="table-responsive"  width="100%">
                        <tr style="margin-top:5px">
                            ...
                            <td style="background-color:#fff !important; width: 9%;">
                        ...
                        <tr style="margin-top:5px">
                            <td style="background-color:#fff !important; width: 32%;">
                                <div style="float:left;">
                                   ...
                                   <apex:outputLabel value="Other" id="fiL3abel" style="margin-left:10px;margin-right:5px;"/>
                                </div>
...
<!-- c------------------------------------------------------------------------------------------------------------------------c -->
        ...
        <!--<div class="" style="display: inline-block; width: 150px !important">
            ...
            <span>&nbsp;</span>
            <apex:commandButton value="Back" id="nextBtnBack" action="{!processPaypalTransactionsUndo}" styleClass="button_reg"/>
        </div>-->
        <div class="col-sm-3" style="margin-bottom: 30px!important;">
        <apex:commandButton value="Back" id="nextBtnBack" action="{!processPaypalTransactionsUndo}" styleClass="btn button_reg"/>
        </div>
        <div class="col-sm-3" style="margin-bottom: 30px!important;">
        <apex:commandButton value="Process Charges" id="test" action="{!processPaypalTransactions}" styleClass="btn button_reg btncharge" />
        <apex:commandButton value="Processing..." id="testdisabled" disabled="true" styleClass="btn button_reg btnprocessing" style="display: none;"/>
        </div>
        ...
        <apex:outputPanel layout="none" rendered="{!NOT(confirmTransactions)}">
            <div class="form-group" >
                    ...
                    <div class="col-sm-3"></div>
                        <apex:outputLabel value="Billing Address" id="billingLabel" styleClass="col-sm-2 myFirstName" style="text-align:right;padding-right: 10px;"/>
                    </strong></h4>
       ...
       <apex:outputPanel id="paymentAddressPnl">
            <div class="form-group">
            <div class="col-sm-3"></div>
                <apex:outputLabel value="Address" id="addressLabel" styleClass="col-sm-2" style="text-align:right; padding-right: 10px;"/>
<!--                 <div class="col-sm-1" style="font-size: 180%;color: red; text-align:left;"></div> -->
            ...
            <div class="form-group">
            <div class="col-sm-3"></div>
                <apex:outputLabel value="City" id="cityLabel" styleClass="col-sm-2" style="text-align:right; padding-right: 10px;" />
<!--                 <div class="col-sm-1" style="font-size: 180%;color: red; text-align:left;"></div> -->
                <div class="col-sm-3">
...
<!--         <apex:outputPanel id="state"> -->
            <div class="form-group">
            <div class="col-sm-3"></div>
                <apex:outputLabel value="State" id="stateLabel" styleClass="col-sm-2" style="text-align:right; padding-right: 10px;"/>
<!--                 <div class="col-sm-1" style="font-size: 180%;color: red; text-align:left;"></div> -->
                <div class="col-sm-3">
...
<!--         </apex:outputPanel> -->
            <div class="form-group">
            <div class="col-sm-3"></div>
                <apex:outputLabel value="Zip Code" id="zipLabel" styleClass="col-sm-2" style="text-align:right; padding-right: 10px;"/>
<!--                 <div class="col-sm-1" style="font-size: 180%;color: red; text-align:left;"></div> -->
                <div class="col-sm-3">
                ...
                <div style="font-size: 180%;color: red; text-align:left; float:left;margin-left:15px;">*</div>
            </div>
             </apex:outputPanel>
            ...
            <div class="form-group">
            <div class="col-sm-3"></div>
                <apex:outputLabel value="Country" id="countryLabel" styleClass="col-sm-2" style="text-align:right; padding-right:10px;"/>
...
<!--         </apex:outputPanel> -->
            ...
            <div class="form-group">
            <div class="col-sm-3"></div>
                <apex:outputLabel value="Card Holder Name" id="cardNameLabel" styleClass="col-sm-2" style="text-align:right; padding-right: 10px;"/>
            ...
            <div class="form-group">
            <div class="col-sm-3"></div>
                <apex:outputLabel value="Card Number" id="cardNumberLabel" styleClass="col-sm-2" style="text-align:right; padding-right: 10px;"/>
            ...
            <div class="form-group">
            <div class="col-sm-3"></div>
                <apex:outputLabel value="Expiration Month" id="expirationLabel" styleClass="col-sm-2" style="text-align:right; padding-right: 10px;"/>
            ...
            <div class="form-group">
            <div class="col-sm-3"></div>
                <apex:outputLabel value="Expiration Year" id="expirationLabel1" styleClass="col-sm-2" style="text-align:right; padding-right: 10px;"/>
<!--                 <div class="col-sm-1" style="font-size: 180%;color: red; text-align:left;"></div> -->
                    <div class="col-sm-3">
            ...
            <div class="form-group">
            <div class="col-sm-3"></div>
                <apex:outputLabel value="Security Code" id="securityLabel" styleClass="col-sm-2" style="text-align:right; padding-right: 10px;"/>
            ...
            <div class="form-group">
               <div class="col-sm-5">&nbsp;</div> 
                <div class="col-sm-3 butright">
                    <apex:commandButton value="Confirm" id="nextBtn" action="{!processMyOrder}" styleClass="button_reg submitButton" status="buttons_group_status"></apex:commandButton>
